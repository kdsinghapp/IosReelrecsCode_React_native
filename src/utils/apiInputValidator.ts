 ...
 */
export const validateImdbId = (imdbId: any): ValidationResult => {
 ...
 * Validates username
 */
export const validateUsername = (username: any): ValidationResult => {
 ...
 * Validates group ID
 */
export const validateGroupId = (groupId: any): ValidationResult => {
 ...
 */
export const validatePage = (page: any): { isValid: boolean; value: number; error?: string } => {
 ...
 * Validates page size
 */
export const validatePageSize = (pageSize: any): { isValid: boolean; value: number; error?: string } => {
 ...
 */
export const sanitizeUrlParam = (param: any): string => {
 ...
 */
export const createSafeParams = (params: Record<string, any>): Record<string, string | number> => {
