...
const PlatformModales = ({ visible,
    ...
    //             console.log(ok.subscription, 'response__platddssfrom_dfgh__data_select')
    //             togglePlatform(ok.subscription)

    //         })
    //         // console.log(response.data[0].subscription, 'response__platfrom_data_select')
    //     } catch (error) {
    ...
    //     console.log(platformName , 'car__thaar')
    //     setSelectedPlatforms(prev =>
