...
import { Button, CustomStatusBar, HeaderCustom } from '../../../../component'
...
const StreamService = () => {
  ...
  // console.log(fromSignUp, "_fromSignUp____")
  ...
  const fetchPlatformsPage = async ({
    ...
    try {
      ...
      console.error('fetchPlatformsPage error', err);
    } finally {
  ...
  //   console.log(platformData, 'data', platformData, 'platformData____platformData')
  //   if (searchQuery) {
  ...
  //     console.log('popular_popular__platformData_platformData', data)
  //   } else if (filterMode === 'more') {
  //     data = data.filter(item => item?.popular === false);
  //   }
  //   console.log(data, 'data__getFilteredData')
  //   return data;
  // };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.streamHeader} >
          ...
          />
          <Text style={styles.selectText} >Select your streaming service</Text>
          <View style={styles.serviceCountComntainer}>
            ...
            <Text style={[styles.serviceSelectText, { fontSize: 14 }]}>
              {selectedPlatforms?.length} <Text style={styles.serviceSelectText}>Selected</Text>
            </Text>
          </View>
          ...
          {selectedPlatforms.length > 0 ? (
            ...
            <View style={{ paddingHorizontal: 14 }} >
              <Text style={styles.streamAllText} >Simplily your Streaming experience. Discover new conent across all your services-all in one app</Text>
            </View>
          }
        </View>
        {/* search bar */}
        <View style={styles.searchContainer} >
          <View style={{ flexDirection: 'row', alignItems: 'center' }} >
            ...
            <TextInput
              placeholder='Search Streaming Service'
        ...
        <View style={styles.dataSelectContainer}>
          ...
          >
            <Text style={[styles.mostPopularText, { fontFamily: filterMode === 'popular' ? font.PoppinsBold : font.PoppinsRegular }]}>Most Popular</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.mostPopularContainer,
          ...
          >
            <Text style={[styles.mostPopularText, { fontFamily: filterMode === 'more' ? font.PoppinsBold : font.PoppinsRegular }]}>All Platforms</Text>
          ...
          <FlatList
            ...
            ListEmptyComponent={() => {
              ...
              if (!isLoading && platformData.length === 0 && debouncedSearch?.length > 0) {
                return <Text style={styles.noResultsText}>No services found</Text>;
              }
              return null;
            }}
