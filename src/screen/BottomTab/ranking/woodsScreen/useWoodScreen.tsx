  ...
  const searchGroupFromApi = useCallback(async (query: string) => {
    try {
      ...
      const enrichedGroups = await Promise.all(
        basicGroups.map(async (group: any) => {
           let activities = [];
          let members = [];
...
//  members = group?.members ;
          try {
            ...
            console.warn(`⚠️ Activities fetch failed for ${groupId}:`, err.message);
          }
...
//       const result = await fetchSearchMovies(query, token);
//       setFilteredItems(result?.data?.results);
//       console.log(filteredItems, "chaiwala")
//     } catch (error) {
//       console.error("Search Movie error:", error);
//       setFilteredItems([]);
//     } finally {
...
//     console.log(groups, ":groupdata___-"); 
...
//             console.log(groupsRes ,  "groupsRes____groupsRes")
//           // const enrichedGroups = await Promise.all(
...
//           //       console.log(members ,  "membersggroupde___= - =- -__")
...
//           //       };
//           //     } catch (innerErr) {
//           //       console.error(`❌ Error processing group ${group.group_id}`, innerErr);
//           //       return null;
//           //     }
//           //   })
//           // );
...
//           // console.log(filteredGroups, "✅ Final enrichedGroups");
//         } catch (error) {
...
// console.log(groupsData , "groupsData______groupsData________")
