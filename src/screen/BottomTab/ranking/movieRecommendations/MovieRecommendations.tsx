...
//   console.log(rankingCurrentStep, selectedMovieId, " - -/  - recommmanded")
//   console.log(selectedMovieId, " - -  - recommmanded")
//   const handleSearch = () => {
...
//   // console.log(storedStep + " =---------  stop")
//   // console.log(currentStep + "       -------     ------dcurt")
...
//         console.log(res.results, "✅ matching data h");
//       } catch (error) {
...
//         }
//       } catch (error) {
//         console.error("❌ Failed to fetch recommend movies:", error);
//       }
//     };
...
//   const renderNormalMovie = useCallback(({ item }: any) => {
...
//         onSelectFirst={() => {
//           console.log('Selected first movie')
//           handleStepProgress();
//           console.log('StepProgressModal call in card')
//         }}
//         onSelectSecond={() => {
//           console.log('Selected second movie');
//           console.log('StepProgressModal call in card')
//           handleStepProgress();
//         }}
