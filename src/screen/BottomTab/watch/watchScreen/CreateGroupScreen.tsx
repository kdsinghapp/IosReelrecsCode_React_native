...
import { CustomStatusBar, HeaderCustom, SuccessMessageCustom } from '@components';
...
setTimeout(() => {
    ...
    const fetchGroupDetails = async () => {
      ...
      try {
        ...
        try {
          ...
          console.warn("⚠️ Failed to fetch activities:", err.message);
        }
  ...
  //     console.log(groupsData, "<-- ✅ Navigating with final data");
  //     navigation.navigate('WatchWithFrind', {
  //       group: groupsData,
  //       groupId: group_Id,
