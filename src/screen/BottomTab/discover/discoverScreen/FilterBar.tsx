...
const FilterBar = ({ isSelectList,
  ...
  //     console.log(platformString , "platformString_________")
  //     setPlatformFilterString(platformString);
  //     console.log(platformFilterString, " fddfhgg vgf -v ge-ea")

  //     console.log(plateFromItemName, "selecgt   -  -")
  //   } else {
  ...
  useEffect(() => {
    const handleUniqueGenres = async () => {
      try {
        const response = await getUniqueGenres(token);
        console.log(response, "handleUniqueGenres___handleUniqueGenres")
    ...
    if (token && genreModalVisible) handleUniqueGenres()
  ...
  //       console.log(data?.results ,"_________________dataavailablePlatformsplatformsData ")
  ...
  useEffect(() => {
    const fetchPlatforms = async () => {
      try {
        ...
        console.log(platforms, "✅ Cleaned platform data with encoded image URLs");
      } catch (error) {
        console.error("❌ Error fetching platforms:", error);
      }
    };
  ...
  const fixImageUrl = (imageUrl: string): string => {
    try {
      ...
      console.warn('❌ Failed to encode image URL:', imageUrl);
      return imageUrl;
    }
  };
  ...
  const renderItem = ({ item }) => {
    ...
    // console.log(platformsData, "selectedPlatform___Items________")
    return (
      <TouchableOpacity
