...
const {setFeedBAckSucc}  =  route.params || {}
  ...
  const handleFormPress = async () => {
    ...
    if (feedBaCkText === '') {
      setToestMess(true);
      setToestMessGreen(false);
      setToastMessage('Please select a feedback type');
      return;
    }
    try {
  ...
  routes: [
    {
      ...
      console.error("Error handling form press:", error);
    } finally {
      setToestMess(false);
      setToestMessGreen(false);
      setToastMessage('');
    ...
    return (
      <>
        <TouchableWithoutFeedback onPress={() => textInputRef.current?.focus()}>
          <View style={[
            ...
            <TextInput
              ...
              placeholder="Please describe your idea or feedback"
              multiline={true}
        ...
        <View style={styles.CheckContainer}>
          ...
          <Text style={styles.checkText}>Make this anonymous</Text>
        </View>
  ...
  const renderFeedbackOptions = () => {
    return (
      ...
      >
        ...
        >
          <Text style={[styles.optionText, { color: feedBaCkText === "Feature Request" ? Color.primary : Color.whiteText, fontFamily: feedBaCkText === "Feature Request" ? font.PoppinsBold : font.PoppinsMedium }]}>Feature Request</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[styles.optionText, { color: feedBaCkText === "General Feedback" ? Color.primary : Color.whiteText, fontFamily: feedBaCkText === "General Feedback" ? font.PoppinsBold : font.PoppinsMedium }]}>General Feedback</Text>
        </TouchableOpacity>
      </Animated.View>
    );
  };
    ...
    return (
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          >
            <Text style={styles.suggestionsText}>Have an Idea for Suggestions?</Text>
            ...
            >
              ...
              >
                <Text style={styles.sectionTitle}>
                  {feedBaCkText ? feedBaCkText : 'Type of Feedback'}
                </Text>
                <Image
