...
interface HeaderCustomProps {
  ...
  onBackPressW?: () => void;
  onRightPress?: () => void;
  backIcon?: any;         // keeping 'any' for Image source
  rightIcon?: any;
    ...
    <View style={[
      ...
      {multiplename
        ? <View style={styles.multiplenameContainer} >
           <Text  allowFontScaling={false}   style={styles.title}>You</Text>
            <Text   allowFontScaling={false} style={styles.andText}>and</Text>
