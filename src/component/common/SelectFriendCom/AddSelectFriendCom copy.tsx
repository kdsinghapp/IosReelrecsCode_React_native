...
const AddSelectFriendCom: React.FC<Props> = ({
  setSearchFocused,
  onSelectionChange,
  type,
  token,
...
const re = formattedFriends
  ...
  const toggleSelect = useCallback((id: string) => {
    ...
    console.log("----filteridforAddfriend",filteridforAddfriend)
  ...
  // ), [members ,setAddMembers]);
    ...
    // console.log(addmembers, "chacla n")
    // console.log(token, "token eee chala chala re")
    useEffect(()=>{
        loadData()
    },[])
...
// console.log("addmembers1",addmembers1)
...
export default memo(AddSelectFriendCom);
