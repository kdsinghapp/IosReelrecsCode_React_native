...
const GroupActivityFeed: React.FC<Props> = ({ groupActivity }) => {
  ...
  console.log(currentItem , 'currentItem_name__acotiviety')
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {`${currentItem?.user?.name ?? currentItem?.user?.username} ${isLiked ? 'liked' : 'disliked'} ${currentItem?.movie?.title} on ${currentItem?.pref_record_date}`}
