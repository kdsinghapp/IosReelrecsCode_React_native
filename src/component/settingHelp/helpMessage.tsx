...
// import { CustomStatusBar, HeaderCustom, SearchBarCustom } from '@components'
// import imageIndex from '@assets/imageIndex'
import { useNavigation, useRoute } from '@react-navigation/native'
import {CustomStatusBar, HeaderCustom, SearchBarCustom } from '..'
import imageIndex from '../../assets/imageIndex'
...
<View>
     <Text style={[styles.headingText, {fontSize:16, marginLeft:0}]}>What to Do If the Movie Won’t Play</Text>
              <Text style={styles.detailText} >If you’re having trouble playing a movie, please try the following steps:</Text>
