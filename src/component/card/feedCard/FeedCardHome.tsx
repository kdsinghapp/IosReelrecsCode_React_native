...
const FeedCardHome = ({
  ...
  useEffect(() => {
    ...
    // console.log('videoUri__changed__render____', videoUri)
  }, [videoUriRef.current])
  ...
  // console.log('isMute_ka_item__hai_ye', isMu)
  useEffect(() => {
    videoUriRef.current = videoUri;
  }, [videoUri]);
  // console.log(videoUri, "chashc");
  ...
  const shouldTrigger = paused && !hasInteractedRef.current && imdb_id;
    if (shouldTrigger) {
      ...
      // console.log("🚀 Triggered__after__pause:", imdb_id);
