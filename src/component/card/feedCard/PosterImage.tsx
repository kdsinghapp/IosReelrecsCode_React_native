...
const PosterImage = ({ poster , style }) => {
    ...
    console.log('PosterImage poster prop:', poster);
console.log('Poster URI =>', typeof poster === 'string' ? poster : poster?.uri);
  ...
  onError={(e) => {
    console.log('❌ FastImage failed to load:', e.nativeEvent);
    setLoading(false);
    setError(true);
  }}
/>
