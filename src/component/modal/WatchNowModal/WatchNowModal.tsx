...
const WatchNowModal = ({ visible, token, onClose, selectedImdbId, watchModalLoad, setWatchModalLoad, country = 'US' }) => {
  ...
  // console.log(selectedImdbId, "fnefnfefe")
  const fetchData = async () => {
    ...
    try {
      ...
      // console.log(data?.data , "data_____movie")
    } catch (error) {
      console.log(fetchData, "fetchData platFrom error")
    } finally {
  ...
  // console.log(platforms, "___platforms____")
  ...
  // console.log(platforms.length , "length___find")
