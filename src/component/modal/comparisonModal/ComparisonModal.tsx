...
const ComparisonModal: React.FC<ComparisonModalProps> = ({
  ...
  // console.log(firstMovie , "firstMovie1__________1", 
  // secondMovie , "secondMovie2________"
  // )
  // console.log(secondMovie , "secondMovie__________")
  ...
  // console.log(secondMovie.title, 'okkkk', currentSecondMovie.title,)
  // console.log(currentSecondMovie , "currentSecondMovie__currentSecondMovie")


  useEffect(() => {
    // console.log('itsRunnn___repit_movie')
...
<TouchableOpacity onPress={() => handleSelection(currentSecondMovie, false)} /> */}
  // console.log(comparisonMovies, "rendum three movie")
  // console.log(selected ,"selected1____selected")
  return (
