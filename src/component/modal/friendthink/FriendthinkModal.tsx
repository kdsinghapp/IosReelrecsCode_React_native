...
const FriendthinkModal: React.FC<Props> = ({ visible, onClose, reviews, type, headaing, groupActivity, ranking_react }) => {
  console.log(ranking_react, "ranking_react___")
  const navigation = useNavigation();
    const { token, userGetData } = useSelector((state: RootState) => state.auth);
  console.log(token, userGetData ,userGetData ,  'grpup__data_from_data')
   ...
   console.log(isUserName_Login , 'group_userNamehere')
  // console.log(reviews, "reviewsana")
  // console.log(groupActivity, "________groupActivity____________")
  const renderItem = ({ item }: { item: any }) => {
    console.log(item, "item__fromGropu_detail_modal")
