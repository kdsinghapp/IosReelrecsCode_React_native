...
const FeedbackModal: React.FC<FeedbackModalProps> = ({
  ...
  const nextPress = async () => {
    ...
    Keyboard.dismiss();
    // console.log(preference, "__s__dwddModal");
    // console.log(text, preference, selectedMovie?.imdb_id, imdb_id, "__commnet__wqithpreference___");
    ...
    if (preference) {
      ...
      try {
        if (text.trim() !== '') {
          ...
          console.log(response, 'post__Comment__with_preference');
        } else {
          fileLogger.info('Comment text empty, skipping post');
          console.log("Comment text is empty, not posting!");
        }
        ...
        console.log('error in post__api__call', error);
